                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class='col-md-4'>
                                    ...
                                    <input type="email" class="form-control" name="email" value="<?php echo $data['mobile']?>" required>
                                </div>
                                <div class='col-md-4'>
                            ...
                            <div class="form-group">
                                ...
                                <div class='col-md-4'>
                                    ...
                                    <select id="role" name="role" class="form-control">
                                        <option value="">Select</option>
                                        <option value="Subject Staff"<?=$data['role'] == 'Subject Staff' ? ' selected="selected"' : '';?>>Subject Staff</option>
