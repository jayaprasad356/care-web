<section class="content-header">
    ...
    <ol class="breadcrumb">
        <a class="btn btn-block btn-default" href="add-subject.php"><i class="fa fa-plus-square"></i> Add New Subject</a>
    </ol>
                        ...
                        <table id='students_table' class="table table-hover" data-toggle="table" data-url="api-firebase/get-bootstrap-table-data.php?table=subjects" data-page-list="[5, 10, 20, 50, 100, 200]" data-show-refresh="true" data-show-columns="true" data-side-pagination="server" data-pagination="true" data-search="true" data-trim-on-search="false" data-filter-control="true" data-query-params="queryParams" data-sort-name="id" data-sort-order="desc" data-show-export="true" data-export-types='["txt","excel"]' data-export-options='{
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th data-field="subject_name" data-sortable="true">Subject Name</th>
